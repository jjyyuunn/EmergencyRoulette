...
namespace EmergencyRoulette
{
    public class SymbolLibrary
    {
        ...
        public SymbolLibrary()
        {
            ...
            _symbolLibrary[SymbolType.Food] = new SymbolInfo(SymbolType.Energy, SymbolCategory.Resource, 0.5f);
            _symbolLibrary[SymbolType.Data] = new SymbolInfo(SymbolType.Medical, SymbolCategory.Resource, 0.5f);
